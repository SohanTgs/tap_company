                    ...
                    <div class="table-responsive table-responsive--sm">
                        <table class="default-data-table table ">
                            ...
                            <tr>
                                ...
                                <th scope="col">@lang('Receiver Email')</th>
                             ...
                             <tbody>
                                @php($i=1)
                                @foreach($BalanceReceivers as $receiver)
                                    <tr>
                                        <td>{{ $i++ }}</td>
                                        <td>{{ $receiver->receiverName->fullname }}</td>
                                        <td>{{ $receiver->receiverName->email }}</td>
                                        <td>{{ $receiver->amount }} {{ $receiver->currency_code }}</td>
                                        <td>{{ number_format($receiver->charge,2) }} {{ $receiver->currency_code }}</td>
                                        <td>{{ number_format($receiver->amount+$receiver->charge,2) }} {{ $receiver->currency_code }}</td>
                                        <td>
