    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.bonus.setting')}}">
                    <a href="{{route('admin.bonus.setting')}}" class="nav-link"
                       data-default-url="{{ route('admin.bonus.setting') }}">
                        <i class="menu-icon las la-money-bill-wave-alt"></i>
                        <span class="menu-title">@lang('Bonus Setting') </span>
                    </a>
                </li>

                 <li class="sidebar-menu-item  {{menuActive('admin.level.tree')}}">
                    <a href="{{route('admin.level.tree')}}" class="nav-link"
                       data-default-url="{{ route('admin.level.tree') }}">
                        <i class="menu-icon las la-tree"></i>
                        <span class="menu-title">@lang('Deposit Level Tree') </span>
                    </a>
                </li>

                  <li class="sidebar-menu-item  {{menuActive('admin.money.transfer')}}">
                    <a href="{{route('admin.money.transfer')}}" class="nav-link"
                       data-default-url="{{ route('admin.money.transfer') }}">
                        <i class="menu-icon las la-history"></i>
                        <span class="menu-title">@lang('Transfer History') </span>
                    </a>
                </li>

                 <li class="sidebar-menu-item  {{menuActive('admin.provide.bonus')}}">
                    <a href="{{route('admin.provide.bonus')}}" class="nav-link"
                       data-default-url="{{ route('admin.provide.bonus') }}">
                        <i class="menu-icon las la-exchange-alt"></i>
                        <span class="menu-title">@lang('Provide Bonus') </span>
                    </a>
                </li>

                <li class="sidebar-menu-item  {{menuActive('admin.api.currency')}}">
                    <a href="{{route('admin.api.currency')}}" class="nav-link"
                       data-default-url="{{ route('admin.api.currency') }}">
                        <i class="menu-icon las la-percent"></i>
                        <span class="menu-title">@lang('Conversion Rate') </span>
                    </a>
                </li>
