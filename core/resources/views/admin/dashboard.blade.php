            ...
            <div class="dashboard-w1 bg--gradi-44 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        ...
                        <span class="amount">{{ number_format($widget['total_regi_bonus'],2) }}</span>
                        <span class="currency-sign">{{ $general->cur_sym }}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">Total Registration Bonus</span>
                    </div>

                    <a href="{{ route('admin.total.registraion.bonus') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-7 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="status"></span>
                        <span class="amount">{{ @$widget['top_referral_sum']['count'] }}</span>
                        <span class="currency-sign"></span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">Top Referrar</span>
                    </div>

                    <a href="{{ route('admin.top.referral') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">View All</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-35 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($widget['total_referral_regi_bonus'],2) }}</span>
                        <span class="currency-sign">{{ __($general->cur_sym) }}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">Total Referral Registration Bonus</span>
                    </div>

                    <a href="{{ route('admin.total.refferal.bonus') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">View All</a>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-35 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($widget['total_deposit_bonus'],2) }}</span>
                        <span class="currency-sign">{{ __($general->cur_sym) }}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">Total Deposit Bonus</span>
                    </div>

                    <a href="{{ route('admin.total.deposit.bonus') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">View All</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-50 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($widget['total_withdraw_bonus'], 2) }}</span>
                        <span class="currency-sign">{{ $general->cur_sym }}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">Total Withdraw Bonus For First Level</span>
                    </div>

                    <a href="{{ route('admin.total.withdraw.bonus') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">View All</a>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-50 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($widget['total_transaction_bonus'], 2) }}</span>
                        <span class="currency-sign">{{ $general->cur_sym }}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">Total Transaction Bonus For First Level</span>
                    </div>

                    <a href="{{ route('admin.total.transaction.bonus') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">View All</a>
                </div>
            </div>
        </div>
         <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-50 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ number_format($widget['total_bonuses'], 2) }}</span>
                        <span class="currency-sign">{{ $general->cur_sym }}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">Overall Total Bosus</span>
                    </div>
                </div>
            </div>
        </div>
         <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-50 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">
                            {{ number_format($widget['profit_or_lose'], 2) }}
                        </span>
                        <span class="currency-sign">{{ $general->cur_sym }}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">
                            @if( $widget['overall_total_bonus'] <= $widget['overall_total_charge'] )
                                Profit
                            @else
                                Lose
                            @endif
