...
function setDepositWithdrawChart(depositWithdrawData) {
    var options = {
        chart: {
            height: 250,
            type: 'area',
        ...
        series: depositWithdrawData.series,

        legend: {
            show: false,
        },
        xaxis: {
            categories: depositWithdrawData.categories,
            labels: {
                style: {
                    colors: "#9aa0ac"
                }
    ...
    var chart = new ApexCharts(
        document.querySelector("#depositWithdrawChart"),
        options
    );
